...
/**
 * CreateTRNServicesMessageReceiverInOut.java
 *
 ...
 */
        ...
        /**
        *  CreateTRNServicesMessageReceiverInOut message receiver
        */

        public class CreateTRNServicesMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver{
        ...
        CreateTRNServicesSkeleton skel = (CreateTRNServicesSkeleton)obj;
        //Out Envelop
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("createTRN".equals(methodName)){
                
                org.apache.axiom.om.OMElement createTRNResponse1 = null;
	                        org.apache.axiom.om.OMElement wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               createTRNResponse1 =
                                                         ...
                                                         skel.createTRN(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), createTRNResponse1, false, new javax.xml.namespace.QName("http://createtrn.trackwise.biogen.com",
                                                    "createTRN"));
