...
public class AttachmentType implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8339973275272628217L;
			...
			if (localBinaryData != null) {
				try {
					org.apache.axiom.util.stax.XMLStreamWriterUtils
							.writeDataHandler(xmlWriter, localBinaryData, null,
									true);
				} catch (java.io.IOException ex) {
					throw new javax.xml.stream.XMLStreamException(
							"Unable to read data handler for binaryData", ex);
				}
			} else {
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localFileNameTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://createtrn.trackwise.biogen.com", "fileName"));
		...
		if (localBinaryDataTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://createtrn.trackwise.biogen.com", "binaryData"));
		...
		public static AttachmentType parse(
			...
			try {
						...
						if (!"AttachmentType".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (AttachmentType) com.biogen.trackwise.createtrn.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object.setBinaryData(org.apache.axiom.util.stax.XMLStreamReaderUtils
